...
(function( $ ){
	...
	/* ----------------------------------------------------------- */
		...
		$('.mu-skill-progress-bar').appear(function() {
		 	...
		 	$('.mu-climbing-bar').LineProgressbar({
				percentage: 95,
				triggerOnce: true
			});

			$('.mu-autonomy-bar').LineProgressbar({
				percentage: 60,
				triggerOnce: true
			});

			$('.mu-excavation-bar').LineProgressbar({
				percentage: 70,
				triggerOnce: true
			});

			$('.mu-mobility-bar').LineProgressbar({
				percentage: 90,
				triggerOnce: true
			});

			$('.mu-dancing-bar').LineProgressbar({
				percentage: 100,
				triggerOnce: true
			});
